          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4 scrollbar-none">
            ...
            {activeTab === "audio" && (
              <div className="space-y-3">
                ...
                >
                  <div>
                    <p className="text-xs font-semibold text-white">Supressão Nativa</p>
                    <p className="text-[11px] text-white/40">Filtro estacionário contra zumbidos</p>
                  </div>
                  {noiseSuppression && <Check className="h-4 w-4 text-emerald-400" />}
                </button>
                ...
                {/* Supressão IA (RNNoise) */}
                <div className="flex items-center justify-between p-3.5 rounded-[14px] bg-white/3 border border-emerald-500/20 shadow-[0_0_20px_rgba(16,185,129,0.06)]">
                  <div>
                    <div className="flex items-center gap-1.5">
                      <Sparkles className="h-3.5 w-3.5 text-emerald-400" />
                      <p className="text-xs font-semibold text-white">Filtro Neural RNNoise</p>
                    </div>
                    <p className="text-[11px] text-white/40 mt-0.5">
                      Elimina cliques de mouse e barulhos de teclado
                    </p>
                  </div>
                  <input
                    type="checkbox"
                    checked={Boolean(advancedNoiseSuppression)}
                    onChange={(e) => onChangeAdvancedNoiseSuppression?.(e.target.checked)}
                    className="h-4 w-4 accent-emerald-400 rounded cursor-pointer"
                  />
                </div>
